...
//    String familyMembersListJson = "";
    ...
    String photoId = "";
    String certificateOfDeceased = "";
    String birthCertificate = "";
    String personalPicture = "";
    String custodyDeclaration = "";
    ...
    public String getYatimeAge() {
        return yatimeAge;
    }

    public void setYatimeAge(String yatimeAge) {
        this.yatimeAge = yatimeAge;
    }
    ...
    public String getCertificateOfDeceased() {
        return certificateOfDeceased;
    }

    public void setCertificateOfDeceased(String certificateOfDeceased) {
        this.certificateOfDeceased = certificateOfDeceased;
    }
    ...
    public String getCustodyDeclaration() {
        return custodyDeclaration;
    }

    public void setCustodyDeclaration(String custodyDeclaration) {
        this.custodyDeclaration = custodyDeclaration;
    }

    public String getGuardianshipImage() {
        return guardianshipImage;
    }

    public void setGuardianshipImage(String guardianshipImage) {
        this.guardianshipImage = guardianshipImage;
    }

    public String getSchoolCertificateImage() {
        return schoolCertificateImage;
    }

    public void setSchoolCertificateImage(String schoolCertificateImage) {
        this.schoolCertificateImage = schoolCertificateImage;
    }

    public String getSalarySlipIfAny() {
        return salarySlipIfAny;
    }

    public void setSalarySlipIfAny(String salarySlipIfAny) {
        this.salarySlipIfAny = salarySlipIfAny;
    }
